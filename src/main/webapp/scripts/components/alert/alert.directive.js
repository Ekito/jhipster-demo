        ...
        return {
            ...
            controller: ['$scope',
                function($scope) {
                    ...
                    var cleanHttpErrorListener = $rootScope.$on('ynovApp.httpError', function (event, httpResponse) {
                        var i;
                        ...
                        switch (httpResponse.status) {
                            ...
                            case 400:
                                var errorHeader = httpResponse.headers('X-ynovApp-error');
                                var entityKey = httpResponse.headers('X-ynovApp-params');
                                if (errorHeader) {
                                    ...
                                    for (i = 0; i < httpResponse.data.fieldErrors.length; i++) {
                                        ...
                                        var fieldName = $translate.instant('ynovApp.' + fieldError.objectName + '.' + convertedField);
